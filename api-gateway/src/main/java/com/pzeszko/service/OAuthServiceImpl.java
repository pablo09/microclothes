...
//        OAuthRequest dto = new OAuthRequest();
//
//        dto.setUsername(request.getParameter("username"));
//        dto.setPassword(request.getParameter("password"));
//        dto.setClient_id(request.getParameter("clientId"));
//        dto.setGrant_type(request.getParameter("grantType"));
//        dto.setClient_secret(request.getParameter("clientSecret"));
